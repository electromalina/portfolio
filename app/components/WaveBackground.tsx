    ...
    <div className="fixed bottom-0 left-0 right-0 w-full h-[40vh] overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full loading-wave-container wave-layer-1">
        ...
        >
          ...
          <path
            className="wave-path"
            d="M0,100 C200,30 400,170 600,100 C800,30 1000,170 1200,100 C1400,30 1600,170 1800,100 C2000,30 2200,170 2400,100 L2400,200 L0,200 Z"
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full loading-wave-container wave-layer-2">
        ...
        >
          ...
          <path
            className="wave-path"
            d="M0,120 C200,50 400,190 600,120 C800,50 1000,190 1200,120 C1400,50 1600,190 1800,120 C2000,50 2200,190 2400,120 L2400,200 L0,200 Z"
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full loading-wave-container wave-layer-3">
        ...
        >
          ...
          <path
            className="wave-path"
            d="M0,140 C200,70 400,210 600,140 C800,70 1000,210 1200,140 C1400,70 1600,210 1800,140 C2000,70 2200,210 2400,140 L2400,200 L0,200 Z"
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full loading-wave-container wave-layer-4">
        ...
        >
          ...
          <path
            className="wave-path"
            d="M0,160 C200,90 400,230 600,160 C800,90 1000,230 1200,160 C1400,90 1600,230 1800,160 C2000,90 2200,230 2400,160 L2400,200 L0,200 Z"
      ...
      <div className="absolute bottom-0 left-0 w-[200%] h-full loading-wave-container wave-layer-5">
        ...
        >
          ...
          <path
            className="wave-path"
            d="M0,80 C200,10 400,150 600,80 C800,10 1000,150 1200,80 C1400,10 1600,150 1800,80 C2000,10 2200,150 2400,80 L2400,200 L0,200 Z"
